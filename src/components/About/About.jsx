...
export default function About(props) {
  ...
  return (
    <div className={s.aboutDiv}>
      ...
      <p className={s.aboutP}>Mencionando y agradeciendo a nuestro equipo de trabajo los cuales pueden encontrar grandes proyectos también en ellos. <a className={s.aboutA} href="https://www.instagram.com/agustinpetrini/" rel="Agustin">Agustin Petrini</a> y <a className={s.aboutA} href="https://www.instagram.com/jonathanmolero/" rel="Jhona">Jhonatan Molero</a>  </p>
